  ...
  return (
    <div style={{ position: 'fixed', right: 18, bottom: 18, zIndex: 60 }}>
      {!open ? (
        ...
        <div className="holo-card" style={{ width: 380, maxWidth: 'calc(100vw - 36px)', padding: 16 }}>
          {/* Header */}
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 12, marginBottom: 12 }}>
            ...
            <button
              ...
              style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: 32, height: 32, borderRadius: 8, border: '1px solid rgba(255,255,255,0.12)', background: 'rgba(255,255,255,0.05)', color: 'rgba(255,255,255,0.65)', cursor: 'pointer', flexShrink: 0, transition: 'background 0.15s, color 0.15s' }}
          ...
          {/* Messages */}
          <div style={{ height: 320, overflowY: 'auto', padding: '10px 12px', borderRadius: 12, border: '1px solid rgba(255,255,255,0.08)', background: 'rgba(255,255,255,0.03)' }}>
            {displayed.map((m, i) => (
